...
function validateSettings(body) {
    ...
    if (!Number.isInteger(workTime) || workTime < 1 || workTime > 99)
        return null;
    if (!Number.isInteger(shortBreakTime) || shortBreakTime < 1 || shortBreakTime > 30)
        return null;
    if (!Number.isInteger(longBreakTime) || longBreakTime < 1 || longBreakTime > 60)
        return null;
